...
public class Money implements Serializable, Comparable {
    ...
    private static final long serialVersionUID = -5177333984190300703L;
    ...
    public String getYuan() {
        String a = getAmount().setScale(2).toString();
        return a;
    }

    public static Money getZeroYuanInstance() {
